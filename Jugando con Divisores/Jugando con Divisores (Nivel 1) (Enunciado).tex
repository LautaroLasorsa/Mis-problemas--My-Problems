...
Luego llama a la función \texttt{Divisores(N)} y devuelve en una línea el contenido del vector devuelto por la función.
...
\begin{enumerate}
  \item $1 \leq N \leq 10$ (15 puntos)
  \item $1 \leq N \leq 1.000$ (15 puntos)
  \item $N$ es el producto de 2 primos (20 puntos)
